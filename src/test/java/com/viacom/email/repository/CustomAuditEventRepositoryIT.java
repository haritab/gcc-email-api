package com.viacom.email.repository;

import com.viacom.email.EmailapiApp;
import com.viacom.email.config.Constants;
import com.viacom.email.config.audit.AuditEventConverter;
import com.viacom.email.domain.PersistentAuditEvent;
...
import static com.viacom.email.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
